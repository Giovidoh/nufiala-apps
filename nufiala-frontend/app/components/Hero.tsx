...
const Hero = () => {
    ...
    // Animation variants that will be used conditionally
    const fadeInUp = {
            ...
            <div className="section-container">
                <div className="flex flex-col lg:flex-row items-center justify-between gap-12">
                    ...
                    >
                        ...
                        >
                            <BaseButton href="#courses" variant="primary" size="lg">
                                Prendre un cours
                            </BaseButton>
                            <BaseButton href="#teach" variant="secondary" size="lg">
                                Donner des cours
                            </BaseButton>
                        </motion.div>
                    </motion.div>
